...
def get_args():
    ...
    parser.add_argument('--ckpt', type=str, default='./log/Exp1_3/checkpoint_latest.pth.tar_pdenet_best.pth.tar', help="path to checkpoint")
    parser.add_argument("--save_path", type=str, default='./eval/Exp1_3/eval5')
